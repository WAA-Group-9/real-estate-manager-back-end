...
5. **Admin Dashboard:**
    ...
    - Create a dashboard for admins displaying last rented properties, recent customers, and additional features as
      needed.
...
1. **User Registration:**
    ...
    - Users register with the system, providing necessary details such as email, password, and role selection (Owner or
      Customer).
...
12. **Email Updates:**
    - Users receive detailed email updates for significant events, offer confirmations, and transaction-related
      information
